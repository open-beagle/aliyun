...
GitHub Actions 工作流位于 `.github/workflows/newapi.yml`，推送 `newapi` 分支时触发构建。当前构建版本为 `v1.0.0-rc.15`，会构建 `linux/amd64` 和 `linux/arm64` 镜像，并推送到：

- `registry.cn-qingdao.aliyuncs.com/wod/new-api:v1.0.0-rc.15`
- `registry.cn-qingdao.aliyuncs.com/wod/new-api:v1.0.0-rc.15-amd64`
- `registry.cn-qingdao.aliyuncs.com/wod/new-api:v1.0.0-rc.15-arm64`
