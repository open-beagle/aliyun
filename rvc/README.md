...
| 文件               | 说明                                           |
| ------------------ | ---------------------------------------------- |
| `Dockerfile`       | 自定义构建文件，基于 PyTorch 2.4.0 + CUDA 12.4 |
