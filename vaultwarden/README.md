...
GitHub Actions 工作流位于 `.github/workflows/vaultwarden.yml`，推送 `vaultwarden` 分支时触发构建。当前构建版本为 `1.37.3`，会分别构建 `linux/amd64` 和 `linux/arm64` 镜像，并推送到：

- `registry.cn-qingdao.aliyuncs.com/wod/vaultwarden:1.37.3`
- `ghcr.io/open-beagle/vaultwarden:1.37.3`
